...
abstract class BasicBoxTest(
    ...
    private inner class TestFileFactoryImpl(val coroutinesPackage: String) : _root_ide_package_.org.jetbrains.kotlin.test.TestFiles.TestFileFactory<TestModule, TestFile>, Closeable {
